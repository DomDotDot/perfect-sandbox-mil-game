...
const config = {
  ...
  baseUrl: '/perfect-sandbox-mil-game/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'DomDotDot', // Usually your GitHub org/user name.
  projectName: 'perfect-sandbox-mil-game', // Usually your repo name.
